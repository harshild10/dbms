...
create table depositor(
	...
	foreign key(customer_name) references customer(customer_name) on update cascade, 
...
select customer_name from depositor d, accounts a 
...
select d.customer_name from accounts a, branch b, depositor d 
